...
import AddCallForm from "../CompanySidebar/AddCallForm";
import AddMeetingForm from "../CompanySidebar/AddMeetingForm";
import AddNoteForm from "../CompanySidebar/AddNoteForm";
import ActivityIconBar from "../CompanySidebar/ActivityIconBar";
import ActivityRenderer from "../CompanySidebar/ActivityRenderer";

const ProposalActivityTabs = ({
  activeTab,
  handleTabChange,
  tabData,
  loadingStates,
...
export default ProposalActivityTabs;
